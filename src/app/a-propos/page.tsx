...
export default function About() {
  ...
  const logoSrc = (skill: string): string | null => {
    const slugs: Record<string, string | null> = {
      ...
      "Grafana": "grafana", "InfluxDB": "influxdb", "Node-RED": "nodered",
      ...
      "VMware": "vmware", "Proxmox": "proxmox", "QEMU": "qemu",
      "Ansible": "ansible", "Terraform": "terraform", "GitHub Actions": "githubactions", "Kubernetes": "kubernetes",
      ...
      "Trivy": "trivy", "Semgrep": "/semgrep.svg", "OWASP ZAP": "/owasp-zap.svg", "Fail2Ban": "/fail2ban.svg",
